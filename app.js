document.addEventListener('DOMContentLoaded', () => {
    ...
    airdropForm.addEventListener('submit', (e) => {
        ...
        if (editIndex !== '') { airdrops[editIndex] = airdropData; } else { airdrops.unshift(airdropData); }
        saveUserAirdrops(); renderAirdrops(); resetForm();
    });
